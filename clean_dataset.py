...
reject_dir = "rejected"
review_dir = "candidates_for_review"
...
for c in classes:
    ...
    print("Near-duplicates flagged:", summary[c]["near_dup_flagged"], "(review manually in candidates_for_review/)")
    print("Background rejects     :", summary[c]["background_reject"])
    print("Blur/outliers          :", summary[c]["blur"])

print("\n[INFO] Review 'candidates_for_review/' manually (Explorer thumbnail view).")
print("[INFO] Confirmed duplicates: delete from dataset_clean/ if a copy exists there,")
print("[INFO] or leave in candidates_for_review/ if it was never added to dataset_clean/.")